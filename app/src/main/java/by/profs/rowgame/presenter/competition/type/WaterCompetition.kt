...
class WaterCompetition(private val competition: CompetitionInfo) : AbstractCompetition {
    override var phase: Int = AbstractCompetition.BEFORE
    ...
    override suspend fun initCompetitors() {
    ...
    override fun raceTitle(): String {
        ...
        return when {
            phase == AbstractCompetition.START -> context.getString(R.string.phase_start)
            phase == AbstractCompetition.HALF -> context.getString(R.string.phase_half)
            phase == AbstractCompetition.ONE_AND_HALF ->
                context.getString(R.string.phase_one_and_half)
            phase == AbstractCompetition.FINISH -> context.getString(R.string.phase_finish)
