...
import by.profs.rowgame.view.activity.infobar
import by.profs.rowgame.view.fragments.extensions.clearError
import by.profs.rowgame.view.fragments.extensions.getIntOrZero
import by.profs.rowgame.view.fragments.extensions.hasText
import by.profs.rowgame.view.fragments.extensions.setError
    ...
    private fun recruit() {
        ...
        binding.run {
            ...
            if (Recruiter(infoBar).buy(Rower(
                ...
                cost = cost,
                strategy = CompetitionStrategy.FINISH.ordinal
